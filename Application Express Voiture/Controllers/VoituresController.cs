...
namespace Application_Express_Voiture.Controllers
{
    public class VoituresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Marque,Modele,PrixAchat")] Voiture voiture)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Marque,Modele,PrixAchat")] Voiture voiture)
        {
            if (id != voiture.Id)
            {
                return NotFound();
