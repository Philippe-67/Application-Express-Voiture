...
using Application_Express_Voiture.Data;
using Application_Express_Voiture.Models;

namespace Application_Express_Voiture.Controllers
{
    public class ReparationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TypeReparation,PrixDeLaReparation")] Reparation reparation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TypeReparation,PrixDeLaReparation")] Reparation reparation)
        {
            if (id != reparation.Id)
            {
                return NotFound();
